        ...
        >
          <ul className="flex flex-col items-center justify-center gap-8  lg:w-full h-screen">
            <li className="flex w-full justify-evenly items-center">
              ...
              <img className=" lg:w-1/4 xl:w-1/2" src={whitelogo} alt="Logo" />
            </li>
            ...
            <button
              className="p-4 w-4/5 text-2xl hover:bg-zinc-500 flex justify-between items-center 
                   rounded-lg  "
              onClick={() => handleLogout()}
            >
              <span className="">Log out</span>
              <Io5Icons.IoLogOutOutline className=" animate-pulse" />
            </button>
          </ul>
        </nav>
      </IconContext.Provider>
