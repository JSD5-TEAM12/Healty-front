...
const Profile = () => {
  ...
  return (
    <main className='w-full h-[101%] set-index set-top0 set-bg'>
      ...
      <section className=' mt-10 xl:mt-[350px]'>
      ...
      <section className='mx-5 xl:mx-[25%]'>
        <p className='text-2xl border-b-2 my-6'>My activity status</p>
      ...
      <section className='mt-16 mb-10 mx-5 xl:mx-[25%]  flex justify-between   '>
