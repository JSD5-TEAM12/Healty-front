...
const Profile = () => {
  ...
  return (
    <main className='relative set_index  bottom-10'>

      <section className=' relative set_index_container'>
        <img className='blur-sm w-full object-contain relative ' src={profile_user} alt="profile_user" />
      ...
      <section className='mx-5 '>
        <p className='text-2xl border-b-2 mb-10'>My activity status</p>
