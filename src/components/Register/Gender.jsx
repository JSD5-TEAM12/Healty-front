          ...
          <div className="relative w-full flex gap-6 snap-x overflow-x-auto p-2  lg:justify-center md:justify-center">
            ...
            <div className="snap-normal snap-center shrink-0 first:pl-8 last:pr-8 w-40 h-40  bg-zinc-600 p-4 rounded-xl box_gender">
              <button
                ...
                value={"female"}
              >
                <IoFemale className="active:bg-violet-700 focus:outline-none focus:ring focus:ring-violet-300 text-9xl text-white btn_gender " />
              </button>
            </div>
            <div className="snap-normal snap-center shrink-0 first:pl-8 last:pr-8 w-40 h-40  bg-zinc-600 p-4 rounded-xl box_gender">
              <button
                ...
                value={"male"}
              >
                <IoMale className="text-9xl text-white   btn_gender" />
              </button>
            </div>
            <div className="snap-normal snap-center shrink-0 first:pl-8 last:pr-8 w-40 h-40  bg-zinc-600 p-4 rounded-xl box_gender">
              <button
                ...
                value={"malefemale"}
              >
                <IoMaleFemale className="text-9xl text-white  btn_gender" />
              </button>
            </div>
            <div className="snap-center shrink-0 ">
              <div className="shrink-0 w-4 sm:w-48"></div>
